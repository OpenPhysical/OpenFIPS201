...
public final class BerTlvReader {
  private BerTlvReader() {}

  public static Tlv read(byte[] data, int offset) {
    return read(data, offset, data.length);
  }

  public static Tlv read(byte[] data, int offset, int limit) {
    if (data == null) {
  ...
  public static Tlv locate(byte[] data, int offset, int tag) {
    int cursor = offset;
